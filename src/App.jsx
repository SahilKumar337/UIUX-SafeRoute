      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={() => setActiveTab('ppt')} style={{
            ...
            color: 'rgba(255,255,255,0.8)', padding: '6px 12px', borderRadius: 16,
            fontSize: 11, cursor: 'pointer', fontFamily: 'Inter', backdropFilter: 'blur(8px)',
          }}>← Web PPT</button>
          ...
          <div className="glass-card" style={{ marginBottom: '2rem', background: 'linear-gradient(135deg, rgba(99, 102, 241, 0.08), transparent)' }}>
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}>Full HCD blueprint — interactive slides, Figma guide, and live prototype.</p>
              </div>
            </div>
          </div>
        )}
